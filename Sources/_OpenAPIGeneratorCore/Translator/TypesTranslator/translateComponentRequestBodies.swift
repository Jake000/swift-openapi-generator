...
extension TypesFileTranslator {
    ...
    func translateComponentRequestBodies(_ items: OpenAPI.ReferenceDictionary<OpenAPI.Request>) throws -> Declaration {
        let typedItems: [TypedRequestBody] = try items.compactMap { key, item in
            ...
            return try typedRequestBody(typeName: typeName, from: item)
        }
